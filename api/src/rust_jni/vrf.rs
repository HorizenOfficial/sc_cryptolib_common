use super::*;
use crate::ginger_calls::{vrf::*, serialization::is_valid};
...
{
    let public_key = parse_rust_struct_from_jobject::<VRFPk>(&_env, _vrf_public_key, "publicKeyPointer");
...
ffi_export!(
    ...
    let sk = parse_rust_struct_from_jobject::<VRFSk>(&_env, _vrf_secret_key, "secretKeyPointer");
...
ffi_export!(
    fn Java_com_horizen_common_vrfnative_VRFProof_nativeFreeProof(
    _env: JNIEnv,
    _proof: JObject,
)
{
...
) -> jobject
{
    ...
    let secret_key_object = return_jobject(&_env, sk, "com/horizen/common/vrfnative/VRFSecretKey");
    let public_key_object = return_jobject(&_env, pk, "com/horizen/common/vrfnative/VRFPublicKey");

    let class = _env.find_class("com/horizen/common/vrfnative/VRFKeyPair")
...
ffi_export!(
    ...
    let secret_key = parse_rust_struct_from_jobject::<VRFSk>(&_env, sk_object, "secretKeyPointer");
    ...
    let public_key = parse_rust_struct_from_jobject::<VRFPk>(&_env, pk_object, "publicKeyPointer");
    ...
    let class = _env.find_class("com/horizen/common/vrfnative/VRFProveResult")
