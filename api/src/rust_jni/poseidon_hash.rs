...
) -> jobject
{
    ...
    for i in 0..personalization_len {
        ...
        let field = parse_rust_struct_from_jobject::<FieldElement>(&_env, field_obj, "fieldElementPointer");
...
ffi_export!(
    ...
    let digest = parse_mut_rust_struct_from_jobject::<FieldHash>(&_env, _h, "poseidonHashPointer");

    //Read input
    let input = parse_rust_struct_from_jobject::<FieldElement>(&_env, _input, "fieldElementPointer");
