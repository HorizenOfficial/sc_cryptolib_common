...
use crate::ginger_calls::{
    schnorr_signature::*, serialization::is_valid
};
...
ffi_export!(
    ...
    let secret_key = parse_rust_struct_from_jobject::<SchnorrSk>(&_env, sk_object, "secretKeyPointer");
    ...
    let public_key = parse_rust_struct_from_jobject::<SchnorrPk>(&_env, pk_object, "publicKeyPointer");
...
{
    let public_key = parse_rust_struct_from_jobject::<SchnorrPk>(&_env, _public_key, "publicKeyPointer");
...
ffi_export!(
    ...
    let secret_key = parse_rust_struct_from_jobject::<SchnorrSk>(&_env, _secret_key, "secretKeyPointer");
